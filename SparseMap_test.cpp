...
TEST( SparseMap, ctor )
{
	SparseMap< std::uint8_t, float > map;
...
{
	SparseMap< std::uint16_t, float > map{ { 1, 1.f }, { 42, 42.f }, { 16, 16.f }, { 16, 1234.f } };
...
{
	SparseMap< std::uint32_t, float > map{ { 1, {} } };
...
{
	const SparseMap< std::uint16_t, float > map{ { 0, 0.f }, { 1, 1.f }, { 2, 2.f } };
